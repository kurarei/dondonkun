...
/* harmony import */ var _components_MenuModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/MenuModal */ "./resources/js/components/MenuModal.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    MenuModal: _components_MenuModal__WEBPACK_IMPORTED_MODULE_2__["default"],
    ...
    register: function register() {
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function register$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              console.log(this.registerForm); // authストアのregisterアクションを呼び出す
            ...
            case 3:
              _context.next = 5;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(this.$router.push('/mypage'));
  ...
  return _c("header", { staticClass: "l-header l-header__top" }, [
    _c(
      ...
      [
        _c(
          "RouterLink",
          { staticClass: "p-nav__login", attrs: { to: "/login" } },
          [_vm._v("ログイン")]
        ),
        _vm._v(" "),
        _c(
    ...
    _c("section", { staticClass: "p-top__main1" }, [
      ...
      _c(
        ...
        [
          _c(
            "RouterLink",
            { staticClass: "c-button__menu", attrs: { to: "/register" } },
            [_vm._v("無料で始めてみる")]
          )
        ],
        1
