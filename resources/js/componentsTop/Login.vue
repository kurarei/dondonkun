<template>
    <div class="p-login">
      ...
      <RouterLink to="/passReset"><div class="p-login__reset"><p>ログイン出来ない場合</p></div></RouterLink>
      <RouterLink to="/register"><div class="p-login__register"><p>アカウントをお持ちでない方</p></div></RouterLink>
    </div>
</template>
