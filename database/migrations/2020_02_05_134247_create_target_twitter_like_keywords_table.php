...
class CreateTargetTwitterLikeKeywordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('target_twitter_like_keywords', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('target_twitter_like_keywords');
    }
}
